  ...
  return (
    <div className="sticky top-0 w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <ul className=" hidden md:flex ">
        <li className="text-white hover:text-[#fde047]">Home</li>
        <li className="text-white hover:text-[#fde047]">About</li>
        <li className="text-white hover:text-[#fde047]">Experience</li>
        <li className="text-white hover:text-[#fde047]">Work</li>
        <li className="text-white hover:text-[#fde047]">Contact</li>
      </ul>
      {/* hamberg */}
      ...
      <div className=" hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/muhayimanatheo"
            >
              GitHub
              <FaGithub size={30} />
            </a>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://www.muhayitheo17@gmail.com"
            >
              Mail
